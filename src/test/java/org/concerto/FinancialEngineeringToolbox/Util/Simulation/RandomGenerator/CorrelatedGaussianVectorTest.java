...
class CorrelatedGaussianVectorTest {
    ...
    void nextRandomVector() throws ParameterRangeErrorException {
        ...
        CorrelatedGaussianVector CGVG = new CorrelatedGaussianVector(cov, 123);
        for(int i = 0 ; i < N ; i++) {
    ...
    void nextManyRandomVectorThrowsParameterRangeErrorException() {
        double[][] cov = {{1}, {1}};
        assertThrows(ParameterRangeErrorException.class, ()-> new CorrelatedGaussianVector(cov, 123) );
    }
}