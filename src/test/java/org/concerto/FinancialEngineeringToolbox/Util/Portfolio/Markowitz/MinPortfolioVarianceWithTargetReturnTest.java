...
import org.concerto.FinancialEngineeringToolbox.Util.Portfolio.Markowitz.MinPortfolioVarianceWithTargetReturn;
...
class MinPortfolioVarianceWithTargetReturnTest {
    ...
    void geOptimizeResult() throws ParameterIsNullException, ParameterRangeErrorException, UndefinedParameterValueException {
        ...
        Result ret = mpv.geOptimizeResult(data, targetReturn, Constant.ReturnType.common);
        ...
        assertEquals(0.00518, ret.getPortfolioVariance(), Constant.EPSILON);

        assertEquals(0.02091, ret.getWeight("aaa"), Constant.EPSILON);
        assertEquals(0.65537, ret.getWeight("bbb"), Constant.EPSILON);
        assertEquals(0.46854, ret.getWeight("ccc"), Constant.EPSILON);
        assertEquals(-0.64310, ret.getWeight("ddd"), Constant.EPSILON);
        assertEquals(0.49827, ret.getWeight("eee"), Constant.EPSILON);
    }
}